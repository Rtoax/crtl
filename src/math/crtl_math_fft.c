...
crtl_ncrtl_pfa		return valid n for crtl_fcomplex-to-crtl_fcomplex PFA
crtl_ncrtl_pfar		return valid n for real-to-crtl_fcomplex/crtl_fcomplex-to-real PFA
crtl_ncrtl_pfao		return optimal n for crtl_fcomplex-to-crtl_fcomplex PFA
crtl_ncrtl_pfaro		return optimal n for real-to-crtl_fcomplex/crtl_fcomplex-to-real PFA
crtl_pfacc		1D PFA crtl_fcomplex to crtl_fcomplex
crtl_pfacr		1D PFA crtl_fcomplex to real
crtl_pfarc		1D PFA real to crtl_fcomplex
crtl_pfamcc		multiple PFA crtl_fcomplex to real
crtl_pfa2cc		2D PFA crtl_fcomplex to crtl_fcomplex
crtl_pfa2cr		2D PFA crtl_fcomplex to real
crtl_pfa2rc		2D PFA real to crtl_fcomplex
...
Returned:	valid n for real-to-crtl_fcomplex/crtl_fcomplex-to-real prime factor fft
...
z		array[n] of crtl_fcomplex numbers to be transformed in place

Output:
z		array[n] of crtl_fcomplex numbers transformed
...
isign       sign of isign is the sign of exponent in fourier kernel
n           length of transform (see notes below)
cz          array[n/2+1] of crtl_fcomplex values (may be equivalenced to rz)
...
Input:
isign       	sign of isign is the sign of exponent in fourier kernel
n           	number of crtl_fcomplex elements per transform (see notes below)
nt          	number of transforms
k           	stride in crtl_fcomplex elements within transforms
kt          	stride in crtl_fcomplex elements between transforms
z           	array of crtl_fcomplex elements to be transformed in place

Output:
z		array of crtl_fcomplex elements transformed
...
z           	array[n2][n1] of crtl_fcomplex elements to be transformed in place

Output:
z		array[n2][n1] of crtl_fcomplex elements transformed
...
n1          1st (fast) dimension of array to be transformed (see notes)
n2          2nd (slow) dimension of array to be transformed (see notes)
cz          array of crtl_fcomplex values (may be equivalenced to rz)
...
crtl_ncrtl_pfar and crtl_ncrtl_pfaro:
Current implemenations of real-to-crtl_fcomplex and crtl_fcomplex-to-real prime 
factor ffts require that the transform length n be even and that n/2 
be a valid length for a crtl_fcomplex-to-crtl_fcomplex prime factor fft.  The 
value returned by crtl_ncrtl_pfar satisfies these conditions.  Also, see notes 
for crtl_ncrtl_pfa.
...
is required for crtl_pfa to yield meaningful results.  this
restriction implies that n is restricted to the range
	1 <= n <= 720720 (= 5*7*9*11*13*16)

crtl_pfacr:
Because crtl_pfacr uses crtl_pfacc to do most of the work, n must be even 
and n/2 must be a valid length for crtl_pfacc.  The simplest way to
obtain a valid n is via n = crtl_ncrtl_pfar(nmin).  A more optimal n can be 
obtained with crtl_ncrtl_pfaro.

crtl_pfarc:
Because crtl_pfarc uses crtl_pfacc to do most of the work, n must be even 
and n/2 must be a valid length for crtl_pfacc.  The simplest way to
obtain a valid n is via n = crtl_ncrtl_pfar(nmin).  A more optimal n can be 
obtained with crtl_ncrtl_pfaro.

crtl_pfamcc:
To perform a two-dimensional transform of an n1 by n2 crtl_fcomplex array 
(assuming that both n1 and n2 are valid "n"), stored with n1 fast 
and n2 slow:
    crtl_pfamcc(isign,n1,n2,1,n1,z); (to transform 1st dimension)
    crtl_pfamcc(isign,n2,n1,n1,1,z); (to transform 2nd dimension)

crtl_pfa2cc:
Only one (either the 1st or 2nd) dimension of the 2-D array is transformed.

If idim equals 1, then n2 transforms of n1 crtl_fcomplex elements are performed; 
else, if idim equals 2, then n1 transforms of n2 crtl_fcomplex elements are 
performed.
...
To perform a two-dimensional transform of an n1 by n2 crtl_fcomplex array 
(assuming that both n1 and n2 are valid "n"), stored with n1 fast 
and n2 slow:  crtl_pfa2cc(isign,1,n1,n2,z);  crtl_pfa2cc(isign,2,n1,n2,z);

crtl_pfa2cr:
If idim equals 1, then n2 transforms of n1/2+1 crtl_fcomplex elements to n1 real 
elements are performed; else, if idim equals 2, then n1 transforms of n2/2+1 
crtl_fcomplex elements to n2 real elements are performed.
...
n2 or an n1 by n2/2+1 two-dimensional array of crtl_fcomplex elements.

Let n denote the transform length, either n1 or n2, depending on idim.
Because crtl_pfa2rc uses crtl_pfa2cc to do most of the work, n must be even 
and n/2 must be a valid length for crtl_pfa2cc.  The simplest way to
obtain a valid n is via n = crtl_ncrtl_pfar(nmin).  A more optimal n can be 
obtained with crtl_ncrtl_pfaro.

crtl_pfa2rc:
If idim equals 1, then n2 transforms of n1 real elements to n1/2+1 crtl_fcomplex 
elements are performed; else, if idim equals 2, then n1 transforms of n2 
real elements to n2/2+1 crtl_fcomplex elements are performed.
...
int crtl_ncrtl_pfar (int nmin)
/*****************************************************************************
Return smallest valid n not less than nmin for real-to-crtl_fcomplex or 
crtl_fcomplex-to-real prime factor ffts.
******************************************************************************
Input:
nmin		lower bound on returned value
...
*****************************************************************************/
{
    return 2*crtl_ncrtl_pfa((nmin+1)/2);
}

int crtl_ncrtl_pfaro (int nmin, int nmax)
/*****************************************************************************
Return optimal n between nmin and nmax for real-to-crtl_fcomplex or 
crtl_fcomplex-to-real prime factor ffts
******************************************************************************
Input:
nmin		lower bound on returned value
...
factor ffts require that the transform length n be even and that n/2 
be a valid length for a crtl_fcomplex-to-crtl_fcomplex prime factor fft.  The 
value returned by crtl_ncrtl_pfaro satisfies these conditions.  Also, see notes 
for crtl_ncrtl_pfao.
******************************************************************************
Author:  Dave Hale, Colorado School of Mines, 06/16/89
*****************************************************************************/
{
    return 2*crtl_ncrtl_pfao((nmin+1)/2,(nmax+1)/2);
}
...
void crtl_pfacc (int isign, int n, crtl_fcomplex cz[])
/*****************************************************************************
Prime factor fft:  crtl_fcomplex to crtl_fcomplex transform, in place
******************************************************************************
Input:
isign		sign of isign is the sign of exponent in fourier kernel
n		length of transform (see notes below)
...
void crtl_pfacr (int isign, int n, crtl_fcomplex cz[], float rz[])
/*****************************************************************************
Prime factor fft:  crtl_fcomplex to real transform
******************************************************************************
Input:
isign       sign of isign is the sign of exponent in fourier kernel
n           length of transform (see notes below)
...
Also, see notes and references for function crtl_pfacc.
******************************************************************************
Author:  Dave Hale, Colorado School of Mines, 06/13/89
*****************************************************************************/
{
    ...
    /* do crtl_fcomplex to crtl_fcomplex transform */
    crtl_pfacc(isign,n/2,(crtl_fcomplex*)z);
}

void crtl_pfarc (int isign, int n, float rz[], crtl_fcomplex cz[])
/*****************************************************************************
Prime factor fft:  real to crtl_fcomplex transform
******************************************************************************
Input:
isign       sign of isign is the sign of exponent in fourier kernel
n           length of transform; must be even (see notes below)
...
void crtl_pfamcc (int isign, int n, int nt, int k, int kt, crtl_fcomplex cz[])
/*****************************************************************************
Prime factor fft:  multiple crtl_fcomplex to crtl_fcomplex transforms, in place
******************************************************************************
Input:
isign       	sign of isign is the sign of exponent in fourier kernel
n           	number of crtl_fcomplex elements per transform (see notes below)
...
where
    0 <= p <= 4,  0 <= q <= 2,  0 <= r,s,t,u <= 1
is required for crtl_pfamcc to yield meaningful results.  this
restriction implies that n is restricted to the range
    1 <= n <= 720720 (= 5*7*9*11*13*16)
...
void crtl_pfa2cc (int isign, int idim, int n1, int n2, crtl_fcomplex cz[])
/*****************************************************************************
Prime factor fft:  2-D crtl_fcomplex to crtl_fcomplex transforms, in place
******************************************************************************
Input:
isign       	sign of isign is the sign of exponent in fourier kernel
idim        	dimension to transform, either 1 or 2 (see notes)
...
where
    0 <= p <= 4,  0 <= q <= 2,  0 <= r,s,t,u <= 1
is required for crtl_pfa2cc to yield meaningful results.  this
restriction implies that n is restricted to the range
    1 <= n <= 720720 (= 5*7*9*11*13*16)
...
*****************************************************************************/
{
    ...
    /* do multiple crtl_fcomplex to crtl_fcomplex transforms */
    crtl_pfamcc(isign,n,nt,k,kt,cz);
}

void crtl_pfa2cr (int isign, int idim, int n1, int n2, crtl_fcomplex cz[], float rz[])
/*****************************************************************************
Prime factor fft:  2-D crtl_fcomplex to real transforms
******************************************************************************
Input:
isign       sign of isign is the sign of exponent in fourier kernel
idim        dimension to transform, which must be either 1 or 2 (see notes)
...
Also, see notes and references for function crtl_pfa2cc.
******************************************************************************
Author:  Dave Hale, Colorado School of Mines, 06/13/89
...
*****************************************************************************/
{
    ...
    if (idim==1) {
        ...
        /* transform as crtl_fcomplex elements */
        crtl_pfa2cc(isign,1,n1/2,n2,(crtl_fcomplex*)z);

    /* else, if transforming dimension 2 */
    } else {

        /* transform as crtl_fcomplex elements */
        crtl_pfa2cc(isign,2,n1,n2/2,(crtl_fcomplex*)z);
...
void crtl_pfa2rc (int isign, int idim, int n1, int n2, float rz[], crtl_fcomplex cz[])
/*****************************************************************************
Prime factor fft:  2-D real to crtl_fcomplex transforms
******************************************************************************
Input:
isign       sign of isign is the sign of exponent in fourier kernel
idim        dimension to transform, which must be either 1 or 2 (see notes)
...
*****************************************************************************/
{
    ...
    if (idim==1) {
        ...
        /* transform as crtl_fcomplex elements */
        crtl_pfa2cc(isign,1,n1/2,n2,cz);
    ...
    /* else, if transforming dimension 2 */
        ...
        /* transform as crtl_fcomplex elements */
        crtl_pfa2cc(isign,2,n1,n2/2,cz);
...
int rt_crtl_pfafft_cwp_test()
{
#define FLT_EPSILON 1

	int nmin,n,no,nfft,nffto;
	float cpu,total;
	crtl_fcomplex *c=(crtl_fcomplex*)malloc1(sizeof(crtl_fcomplex), 720720);
		
	for (n=0; n<720720; ++n)
		c[n].r = c[n].i = 0.0;

	for (nmin=crtl_ncrtl_pfa(100); nmin<=10000; nmin=crtl_ncrtl_pfa(nmin+1)) {
		n = crtl_ncrtl_pfa(nmin);
		for (nfft=0,total=0.0; total<1.0; ++nfft) {
			cpu = cpusec();
			crtl_pfacc(1,n,c);
			total += cpusec()-cpu+FLT_EPSILON;
		}
		no = crtl_ncrtl_pfao(nmin,2*nmin);
		for (nffto=0,total=0.0; total<1.0; ++nffto) {
			cpu = cpusec();
			crtl_pfacc(1,no,c);
			total += cpusec()-cpu+FLT_EPSILON;
		}
		log_notice("valid n=%d cost=%g optimal n=%d cost=%g\n", n,1.0/nfft,no,1.0/nffto);
	}

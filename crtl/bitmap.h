...
#include "crtl/bits/bits_find.h"
  ...
  */
 unsigned long *crtl_bitmap_alloc(unsigned int nbits);
 void crtl_bitmap_free(unsigned long *bitmap);
  ...
  * for the compiler.
  */
 void crtl_bitmap_cut(unsigned long *dst, const unsigned long *src, unsigned int first, unsigned int cut, unsigned int nbits);
  ...
  */
 unsigned long crtl_bitmap_find_next_zero_area_off(unsigned long *map, unsigned long size,
  ...
  */
 inline unsigned long crtl_bitmap_find_next_zero_area(unsigned long *map, unsigned long size,
                                     unsigned long start, unsigned int nr, unsigned long align_mask);
  ...
  */
 int crtl_bitmap_parse(const char *buf, unsigned int buflen, unsigned long *dst, int nbits);
  ...
  * @nmaskbits: size of bitmap, in bits.
  */
 int crtl_bitmap_parse_user(const char *ubuf, unsigned int ulen, unsigned long *dst, int nbits);
  ...
  */ 
 int crtl_bitmap_parselist(const char *buf, unsigned long *maskp, int nmaskbits);
  ...
  */
 int crtl_bitmap_parselist_user(const char *ubuf, unsigned int ulen, unsigned long *dst, int nbits);
  ...
  * 13 and 15 set.
  */
 void crtl_bitmap_remap(unsigned long *dst, const unsigned long *src, const unsigned long *old, 
  ...
  * returns 13.
  */
 int crtl_bitmap_bitremap(int oldbit, const unsigned long *old, const unsigned long *new, int bits);
  ...
  */
 void crtl_bitmap_onto(unsigned long *dst, const unsigned long *orig, const unsigned long *relmap, unsigned int bits);
  ...
  */
 void crtl_bitmap_fold(unsigned long *dst, const unsigned long *orig, unsigned int sz, unsigned int nbits);
  ...
  * or -errno on failure.
  */
 int crtl_bitmap_find_free_region(unsigned long *bitmap, unsigned int bits, int order);
  ...
  * No return value.
  */
 void crtl_bitmap_release_region(unsigned long *bitmap, unsigned int pos, int order);
  ...
  */
int crtl_bitmap_allocate_region(unsigned long *bitmap, unsigned int pos, int order);



void crtl_bitmap_copy_le(unsigned long *dst, const unsigned long *src, unsigned int nbits);


unsigned int crtl_bitmap_ord_to_pos(const unsigned long *bitmap, unsigned int ord, unsigned int nbits);
int crtl_bitmap_print_to_pagebuf(bool list, char *buf, const unsigned long *maskp, int nmaskbits);
...
#define small_const_nbits(nbits) \
 ...
 inline void crtl_bitmap_zero(unsigned long *dst, unsigned int nbits);
 
 inline void crtl_bitmap_fill(unsigned long *dst, unsigned int nbits);
 
 inline void crtl_bitmap_copy(unsigned long *dst, const unsigned long *src, unsigned int nbits);
 
 
 /*
 * Copy bitmap and clear tail bits in last word.
 */
 inline void crtl_bitmap_copy_clear_tail(unsigned long *dst, const unsigned long *src, unsigned int nbits);
 ...
 */
void crtl_bitmap_from_arr32(unsigned long *bitmap, const uint32_t *buf, unsigned int nbits);
void crtl_bitmap_to_arr32(uint32_t *buf, const unsigned long *bitmap, unsigned int nbits);


inline int crtl_bitmap_and(unsigned long *dst, const unsigned long *src1, const unsigned long *src2, unsigned int nbits);

inline void crtl_bitmap_or(unsigned long *dst, const unsigned long *src1, const unsigned long *src2, unsigned int nbits);

inline void crtl_bitmap_xor(unsigned long *dst, const unsigned long *src1, const unsigned long *src2, unsigned int nbits);

inline int crtl_bitmap_andnot(unsigned long *dst, const unsigned long *src1, const unsigned long *src2, unsigned int nbits);

inline void crtl_bitmap_complement(unsigned long *dst, const unsigned long *src, unsigned int nbits);

inline int crtl_bitmap_equal(const unsigned long *src1, const unsigned long *src2, unsigned int nbits);
  ...
  */
inline bool crtl_bitmap_or_equal(const unsigned long *src1, const unsigned long *src2,
                             const unsigned long *src3, unsigned int nbits);

inline int crtl_bitmap_intersects(const unsigned long *src1, const unsigned long *src2, unsigned int nbits);

inline int crtl_bitmap_subset(const unsigned long *src1, const unsigned long *src2, unsigned int nbits);

inline int crtl_bitmap_empty(const unsigned long *src, unsigned nbits);

inline int crtl_bitmap_full(const unsigned long *src, unsigned int nbits);

inline int crtl_bitmap_weight(const unsigned long *src, unsigned int nbits);

inline void crtl_bitmap_set(unsigned long *map, unsigned int start, unsigned int nbits);

inline void crtl_bitmap_clear(unsigned long *map, unsigned int start, unsigned int nbits);
  ...
  */
inline void crtl_bitmap_shift_right(unsigned long *dst, const unsigned long *src,
  ...
  */
inline void crtl_bitmap_shift_left(unsigned long *dst, const unsigned long *src, unsigned int shift, unsigned int nbits);

inline void crtl_bitmap_replace(unsigned long *dst, const unsigned long *old,
                           const unsigned long *new, const unsigned long *mask,
                           unsigned int nbits);

inline void crtl_bitmap_next_clear_region(unsigned long *bitmap,
                                     unsigned int *rs, unsigned int *re,
                                     unsigned int end);

inline void crtl_bitmap_next_set_region(unsigned long *bitmap,
                                   unsigned int *rs, unsigned int *re,
                                   unsigned int end);
...
#define crtl_bitmap_for_each_set_region(bitmap, rs, re, start, end)		     \
  ...
  */
inline void crtl_bitmap_from_u64(unsigned long *dst, uint64_t mask);
  ...
  * memory region.
  */
 inline unsigned long crtl_bitmap_get_value8(const unsigned long *map, unsigned long start);
 ...
 * @start: bit offset of the 8-bit value; must be a multiple of 8
 */
 inline void crtl_bitmap_set_value8(unsigned long *map, unsigned long value, unsigned long start);

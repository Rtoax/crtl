...
#define CRTL_MSGQ_MSGS_MAX        256
#define CRTL_MSGQ_MSG_MAX_SIZE    1024
 ...
 * @return error number
 */
crtl_mqd_t crtl_msgq_create(long mq_maxmsg, long mq_msgsize);
 ...
 * @return error number
 */
int crtl_msgq_destroy(crtl_mqd_t *mqd);
 ...
 */
int crtl_msgq_async_send(crtl_mqd_t dst_mqd, const char *m_ptr, const size_t m_len);
 ...
 * @return CRTL_ERROR if failed, send size if success
 */
int crtl_msgq_sync_send(crtl_mqd_t dst_mqd, const char *m_ptr, const size_t m_len, 
 ...
 * @return CRTL_ERROR if failed, send size if success
 */
int crtl_msgq_sync_send_ack(const void *const src_sync_msg, const void *ack_msg, size_t ack_len);
 ...
 */
int crtl_msgq_recv(crtl_mqd_t my_mqd, char *m_buf, const int m_len);

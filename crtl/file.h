 ...
 * @return error number
 */
int crtl_scandir_filter_default(const struct dirent* dent);
 ...
 * @return error number
 */
int crtl_scandir_sort_default(const struct dirent** a, const struct dirent** b);
 ...
 * @return error number
 */
int crtl_scandir(const char* maindir, struct dirent*** namelist,
